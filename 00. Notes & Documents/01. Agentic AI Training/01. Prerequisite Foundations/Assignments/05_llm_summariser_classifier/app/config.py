...
class Settings(BaseSettings):
    ...
    app_title: str = Field(default="LLM Summariser & Classifier", validation_alias="APP_TITLE")
    app_debug: bool = Field(default=True, validation_alias="APP_DEBUG")
    llm_service_api_key: str = Field(default="demo-key", validation_alias="LLM_SERVICE_API_KEY")
