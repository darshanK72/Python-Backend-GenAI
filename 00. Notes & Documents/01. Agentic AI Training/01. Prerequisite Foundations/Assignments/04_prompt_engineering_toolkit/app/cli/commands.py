...
# cmd_run_reports - run all three strategies over the reports in a JSON file
def cmd_run_reports(reports_file: Path, *, service: LLMService | None = None) -> int:
    """Run all three strategies over the reports in a JSON file."""
    try:
