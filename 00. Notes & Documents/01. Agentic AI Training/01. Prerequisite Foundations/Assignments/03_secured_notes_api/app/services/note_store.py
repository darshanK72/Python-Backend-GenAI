...
class NoteStore:
    ...
    # __init__ - initialise an empty in-memory note store
    def __init__(self) -> None:
        self._store: dict[int, dict] = {}
        self._next_id = 1

    # reset - clear all notes (used in tests)
    def reset(self) -> None:
        """Clear all notes — used in tests."""
        self._store.clear()
        self._next_id = 1

    # create - create a note with server-assigned id and timestamp
    ...
    # list_notes - return a paginated slice of notes
    ...
    # get - return one note or raise 404
    ...
    # delete - delete a note or raise 404
