...
# test_route_after_reason_end - test routing to END when final_answer is set
...
# test_route_after_reason_act - test routing to act when a pending action exists
...
# test_route_after_act_returns_reason - test that act always loops back to reason
def test_route_after_act_returns_reason() -> None:
    assert route_after_act(initial_state("test")) == "reason"


# test_graph_runs_react_loop_with_final_answer - test a full reason-act-reason cycle
...
# test_graph_stops_at_max_tool_calls - test the six-tool-call safety guard
