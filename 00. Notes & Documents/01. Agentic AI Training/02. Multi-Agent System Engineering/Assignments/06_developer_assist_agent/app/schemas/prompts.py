...
# REACT_SYSTEM_PROMPT - system prompt for the ReAct reasoning loop
...
# FINALIZE_SYSTEM_PROMPT - system prompt when the tool budget is exhausted
...
# STORY_ESTIMATOR_PROMPT - user prompt template for story point estimation
...
# TECH_STACK_ADVISOR_PROMPT - user prompt template for stack recommendations
...
# DOC_SUMMARISER_PROMPT - user prompt template for documentation summaries
