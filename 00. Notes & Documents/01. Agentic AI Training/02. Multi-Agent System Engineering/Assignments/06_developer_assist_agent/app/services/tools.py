...
# VALID_STORY_POINTS - allowed story point values for story_estimator
VALID_STORY_POINTS = {1, 2, 3, 5, 8, 13}


# story_estimator - return a story point estimate with a two-sentence rationale
...
# tech_stack_advisor - return two or three stack recommendations with reasons
...
# doc_summariser - return exactly three one-sentence bullet points
...
# _contains_story_point - check whether text contains a valid story point value
