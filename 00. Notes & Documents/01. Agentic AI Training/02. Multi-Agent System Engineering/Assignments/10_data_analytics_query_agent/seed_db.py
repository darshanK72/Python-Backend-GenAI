"""Create and seed the analytics SQLite database."""
...
# SCHEMA_SQL - DDL for projects, tasks, team_members, and incidents
SCHEMA_SQL = """
...
# seed_database - insert the assignment seed rows into an empty database
...
# create_database - recreate and seed the SQLite database at db_path
...
# main - recreate and seed analytics.db for evaluators
def main() -> int:
    """Recreate and seed analytics.db for evaluators."""
