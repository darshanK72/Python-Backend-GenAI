...
from app.cli.commands import cmd_demo, cmd_scope
...
# main - run the feature scoping CLI
def main(argv: list[str] | None = None) -> int:
    """Run the feature scoping CLI and return an exit code."""
