...
### Sample incident files — commit under `data/`

Create `data/incident_01.json`, `data/incident_02.json`, `data/incident_03.json`. Submit all 3 using the same `thread_id` to verify memory persistence across calls.
...
- [ ] All 3 incident JSON files under `data/`
