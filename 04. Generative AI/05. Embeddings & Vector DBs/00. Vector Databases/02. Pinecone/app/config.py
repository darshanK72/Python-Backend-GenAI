...
class Settings(BaseSettings):
    ...
    pinecone_index_name: str = Field(default="", validation_alias="PINECONE_INDEX_NAME")
    pinecone_namespace: str = Field(default="notes-docs", validation_alias="PINECONE_NAMESPACE")
    app_title: str = Field(default="Pinecone Vector API", validation_alias="APP_TITLE")
