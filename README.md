...
| 4 | [`04. Generative AI/`](04.%20Generative%20AI/) | LLMs, embeddings, RAG, LangChain, capstone API |
...
00. Notes & Documents/01. Notebooks/  # Archived lesson notebooks (by topic)
04. Generative AI/                    # Phase 4 — runnable Gen AI lessons
```
...
3. **Gen AI** — Use `04. Generative AI/` for runnable lessons; archived Colab notebooks live in `00. Notes & Documents/01. Notebooks/`.

## Notes

- MySQL lessons use `.env` at repo root (see `03. Python Backend/config.example.env`).
- Older WhiteHat Jr lesson notebooks are archived under `00. Notes & Documents/01. Notebooks/` in topic folders (e.g. `01. AI Foundations/01-evolution-of-ai-and-types.ipynb`). Start with `00-complete-syllabus.ipynb`.
